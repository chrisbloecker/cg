...
#define LEVEL_COUNT_OBSTACLES (20)
...
typedef struct {
  Vector3d items[LEVEL_COUNT_ITEMS]          /* Gegenstände        */
 ...
 */
extern Vector3d levelItemAt(Level l, unsigned i);
 ...
 */
extern Vector3d levelObstacleAt(Level l, unsigned i);
 ...
 */
extern Level levelItemAppend(Level l, Vector3d item);
 ...
 */
extern Level levelObstacleAppend(Level l, Vector3d obstacle);
